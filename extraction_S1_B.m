...
x=(leftPupil_S1_B+rightPupil_S1_B)/2
% hold on 
plot(x,reponses,'+r');
...
% plot(answer_S1_B,timestamp_S1_B_eyes(1:10),'+b');
% set(gca, 'XAxisLocation', 'origin')
% set(gca, 'YAxisLocation', 'origin')
% % title(["Moyenne d'élargissement des pupilles en fonction du temps"])
% xlabel(["réponse moyenne"])
% ylabel(["temps"])